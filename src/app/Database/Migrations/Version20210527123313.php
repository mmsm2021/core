...
final class Version20210527123313 extends AbstractMigration
{
    private const COUNTRIES = [
        ...
        ['name' => 'Libyan Arab Jamahiriya', 'iso3' => 'LBY'],
        ['name' => 'Libya', 'iso3' => 'LBY'],
        ...
        ['name' => 'Saint Vincent & the Grenadines', 'iso3' => 'VCT'],
        ...
        ['name' => 'Taiwan, Province of China', 'iso3' => 'TWN'],
        ...
        ['name' => 'Venezuela, Bolivarian Republic of', 'iso3' => 'VEN'],
    ...
    public function up(Schema $schema): void
    {
        $this->abortIf(
            ...
            'Missing table "' . LocationRepository::TABLE_NAME . '".'
        );
