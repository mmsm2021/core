...
final class Version20210527141108 extends AbstractMigration
{
    private const COUNTRIES = [
        ...
        ['name' => 'British Indian Ocean Territory', 'iso3' => 'IOT'],
        ...
        ['name' => 'Congo', 'iso3' => 'COG'],
        ['name' => 'Congo, the Democratic Republic of the', 'iso3' => 'COD'],
        ...
        ['name' => 'Holy See (Vatican City State)', 'iso3' => 'VAT'],
        ...
        ['name' => 'Iran, Islamic Republic of', 'iso3' => 'IRN'],
        ['name' => 'Iraq', 'iso3' => 'IRQ'],
        ...
        ['name' => 'Korea, Democratic People\'s Republic of', 'iso3' => 'PRK'],
        ...
        ['name' => 'Macao', 'iso3' => 'MAC'],
        ['name' => 'Macedonia, the former Yugoslav Republic of', 'iso3' => 'MKD'],
        ...
        ['name' => 'Moldova, Republic of', 'iso3' => 'MDA'],
        ...
        ['name' => 'Netherlands Antilles', 'iso3' => 'ANT'],
        ...
        ['name' => 'South Georgia and the South Sandwich Islands', 'iso3' => 'SGS'],
        ...
        ['name' => 'Tanzania, United Republic of', 'iso3' => 'TZA'],
        ...
        ['name' => 'United States Minor Outlying Islands', 'iso3' => 'UMI'],
        ['name' => 'Uruguay', 'iso3' => 'URY'],
        ['name' => 'Uzbekistan', 'iso3' => 'UZB'],
        ['name' => 'Vanuatu', 'iso3' => 'VUT'],
        ['name' => 'Venezuela', 'iso3' => 'VEN'],
        ['name' => 'Vietnam', 'iso3' => 'VNM'],
        ['name' => 'Virgin Islands, British', 'iso3' => 'VGB'],
        ['name' => 'Virgin Islands, U.S.', 'iso3' => 'VIR'],
    ...
    {
        return 'Populate "' . CountryRepository::TABLE_NAME . '" table with data.';
    }
    ...
    public function up(Schema $schema): void
    {
        ...
        foreach (self::COUNTRIES as $country) {
            $this->connection->insert(CountryRepository::TABLE_NAME, $country);
        }
    }
    ...
    public function down(Schema $schema): void
    {
        if ($schema->hasTable(CountryRepository::TABLE_NAME)) {
            foreach (self::COUNTRIES as $country) {
                $this->connection->delete(CountryRepository::TABLE_NAME, $country);
            }
        }
    }
}
